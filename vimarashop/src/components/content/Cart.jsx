...
const Cart = () => {
    ...
    const app = (carrito.length != 0) ? <div className='row'> {carritoLocal} </div> : <> <h1>No agregaste diseños al carrito <button className='btn btn-dark'>Volver al shop</button></h1></>
